    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) =>
              DetailProvider(context.read<ApiService>(), GlobalState()),
        ),
      ],
              ...
              child: Consumer<DetailProvider>(
                builder: (context, provider, child) {
                  return switch (provider.resultState) {
                    DetailLoadingResultState() => const Center(
                      child: Padding(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            ElevatedButton.icon(
                              onPressed: () =>
                                  provider.fetchDetailFood(widget.food.name),
                    ...
                    DetailLoadedResultState(result: var mealDetails) => Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Food Info Card
                        Container(
                              ...
                              if (mealDetails[0].strMealThumb.isNotEmpty)
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    ...
                                    fit: BoxFit.cover,
                                    errorBuilder: (context, error, stackTrace) {
                                      return _buildMealImagePlaceholder(theme);
                                    },
                                  ),
                                )
                              else
